...
{
    public static D1Scalar Divide(double a, D1Scalar b)
    {
    ...
    public static D1Scalar Divide(D1Scalar a, double b)
    {
        var da = 1 / b;
    ...
    public static D1Scalar Divide(D1Scalar a, D1Scalar b)
    {
        var da = 1 / b.Constant;
    ...
    public static D2Scalar Divide(double a, D2Scalar b)
    {
        var db = -a / (b.Constant * b.Constant);
    ...
    public static D2Scalar Divide(D2Scalar a, double b)
    {
        var da = 1 / b;
    ...
    public static D2Scalar Divide(D2Scalar a, D2Scalar b)
    {
        var da = 1 / b.Constant;
        var db = -a.Constant / (b.Constant * b.Constant);
    ...
    public static D3Scalar Divide(double a, D3Scalar b)
    {
        var db = -a / (b.Constant * b.Constant);
    ...
    public static D3Scalar Divide(D3Scalar a, double b)
    {
        var da = 1 / b;
    ...
    public static D3Scalar Divide(D3Scalar a, D3Scalar b)
    {
        var da = 1 / b.Constant;
        var db = -a.Constant / (b.Constant * b.Constant);
    ...
    public static D4Scalar Divide(double a, D4Scalar b)
    {
        var db = -a / (b.Constant * b.Constant);
    ...
    public static D4Scalar Divide(D4Scalar a, double b)
    {
        var da = 1 / b;
    ...
    public static D4Scalar Divide(D4Scalar a, D4Scalar b)
    {
        var da = 1 / b.Constant;
        var db = -a.Constant / (b.Constant * b.Constant);
    ...
    public static D5Scalar Divide(double a, D5Scalar b)
    {
        var db = -a / (b.Constant * b.Constant);
    ...
    public static D5Scalar Divide(D5Scalar a, double b)
    {
        var da = 1 / b;
    ...
    public static D5Scalar Divide(D5Scalar a, D5Scalar b)
    {
        var da = 1 / b.Constant;
        var db = -a.Constant / (b.Constant * b.Constant);
    ...
    public static D6Scalar Divide(double a, D6Scalar b)
    {
        var db = -a / (b.Constant * b.Constant);
    ...
    public static D6Scalar Divide(D6Scalar a, double b)
    {
        var da = 1 / b;
    ...
    public static D6Scalar Divide(D6Scalar a, D6Scalar b)
    {
        var da = 1 / b.Constant;
        var db = -a.Constant / (b.Constant * b.Constant);
    ...
    public static D7Scalar Divide(double a, D7Scalar b)
    {
        var db = -a / (b.Constant * b.Constant);
    ...
    public static D7Scalar Divide(D7Scalar a, double b)
    {
        var da = 1 / b;
    ...
    public static D7Scalar Divide(D7Scalar a, D7Scalar b)
    {
        var da = 1 / b.Constant;
        var db = -a.Constant / (b.Constant * b.Constant);
    ...
    public static D8Scalar Divide(double a, D8Scalar b)
    {
        var db = -a / (b.Constant * b.Constant);
    ...
    public static D8Scalar Divide(D8Scalar a, double b)
    {
        var da = 1 / b;
    ...
    public static D8Scalar Divide(D8Scalar a, D8Scalar b)
    {
        var da = 1 / b.Constant;
        var db = -a.Constant / (b.Constant * b.Constant);
    ...
    public static D9Scalar Divide(double a, D9Scalar b)
    {
        var db = -a / (b.Constant * b.Constant);
    ...
    public static D9Scalar Divide(D9Scalar a, double b)
    {
        var da = 1 / b;
    ...
    public static D9Scalar Divide(D9Scalar a, D9Scalar b)
    {
        var da = 1 / b.Constant;
        var db = -a.Constant / (b.Constant * b.Constant);
    ...
    public static D10Scalar Divide(double a, D10Scalar b)
    {
        var db = -a / (b.Constant * b.Constant);
    ...
    public static D10Scalar Divide(D10Scalar a, double b)
    {
        var da = 1 / b;
    ...
    public static D10Scalar Divide(D10Scalar a, D10Scalar b)
    {
        var da = 1 / b.Constant;
        var db = -a.Constant / (b.Constant * b.Constant);
    ...
    public static D11Scalar Divide(double a, D11Scalar b)
    {
        var db = -a / (b.Constant * b.Constant);
    ...
    public static D11Scalar Divide(D11Scalar a, double b)
    {
        var da = 1 / b;
    ...
    public static D11Scalar Divide(D11Scalar a, D11Scalar b)
    {
        var da = 1 / b.Constant;
        var db = -a.Constant / (b.Constant * b.Constant);
    ...
    public static D12Scalar Divide(double a, D12Scalar b)
    {
        var db = -a / (b.Constant * b.Constant);
    ...
    public static D12Scalar Divide(D12Scalar a, double b)
    {
        var da = 1 / b;
    ...
    public static D12Scalar Divide(D12Scalar a, D12Scalar b)
    {
        var da = 1 / b.Constant;
        var db = -a.Constant / (b.Constant * b.Constant);
    ...
    public static DD1Scalar Divide(double a, DD1Scalar b)
    {
        var db = -a / (b.Constant * b.Constant);
        ...
        result.D0 = db * b.D0;
        var cb0 = dbdb * b.D0;
        result.D0D0 = db * b.D0D0 + cb0 * b.D0;
        return result;
    }

    public static DD1Scalar Divide(DD1Scalar a, double b)
    {
        var da = 1 / b;
    ...
    public static DD1Scalar Divide(DD1Scalar a, DD1Scalar b)
    {
        var da = 1 / b.Constant;
        var tmp = da * da;
        ...
        var dadb = -1 * tmp;
        var dbdb = -2 * db * da;
        var result = new DD1Scalar(a.Constant * da);
        result.D0 = da * a.D0 + db * b.D0;
    ...
    public static DD2Scalar Divide(double a, DD2Scalar b)
    {
        var db = -a / (b.Constant * b.Constant);
        var dbdb = 2 * a / (b.Constant * b.Constant * b.Constant);
        ...
        var cb1 = dbdb * b.D1;
        result.D0D0 = db * b.D0D0 + cb0 * b.D0;
        result.D0D1 = db * b.D0D1 + cb0 * b.D1;
        result.D1D1 = db * b.D1D1 + cb1 * b.D1;
        return result;
    }

    public static DD2Scalar Divide(DD2Scalar a, double b)
    {
        var da = 1 / b;
    ...
    public static DD2Scalar Divide(DD2Scalar a, DD2Scalar b)
    {
        var da = 1 / b.Constant;
        var tmp = da * da;
        var db = -a.Constant * tmp;
        var dadb = -1 * tmp;
        var dbdb = -2 * db * da;
        var result = new DD2Scalar(a.Constant * da);
        result.D0 = da * a.D0 + db * b.D0;
        result.D1 = da * a.D1 + db * b.D1;
    ...
    public static DD3Scalar Divide(double a, DD3Scalar b)
    {
        var db = -a / (b.Constant * b.Constant);
        var dbdb = 2 * a / (b.Constant * b.Constant * b.Constant);
        ...
        result.D0D0 = db * b.D0D0 + cb0 * b.D0;
        result.D0D1 = db * b.D0D1 + cb0 * b.D1;
        result.D0D2 = db * b.D0D2 + cb0 * b.D2;
        result.D1D1 = db * b.D1D1 + cb1 * b.D1;
        result.D1D2 = db * b.D1D2 + cb1 * b.D2;
        result.D2D2 = db * b.D2D2 + cb2 * b.D2;
        return result;
    }

    public static DD3Scalar Divide(DD3Scalar a, double b)
    {
        var da = 1 / b;
    ...
    public static DD3Scalar Divide(DD3Scalar a, DD3Scalar b)
    {
        var da = 1 / b.Constant;
        var tmp = da * da;
        var db = -a.Constant * tmp;
        var dadb = -1 * tmp;
        var dbdb = -2 * db * da;
        var result = new DD3Scalar(a.Constant * da);
        result.D0 = da * a.D0 + db * b.D0;
        result.D1 = da * a.D1 + db * b.D1;
        result.D2 = da * a.D2 + db * b.D2;
    ...
    public static DD4Scalar Divide(double a, DD4Scalar b)
    {
        var db = -a / (b.Constant * b.Constant);
        var dbdb = 2 * a / (b.Constant * b.Constant * b.Constant);
        ...
        result.D0D1 = db * b.D0D1 + cb0 * b.D1;
        result.D0D2 = db * b.D0D2 + cb0 * b.D2;
        result.D0D3 = db * b.D0D3 + cb0 * b.D3;
        result.D1D1 = db * b.D1D1 + cb1 * b.D1;
        result.D1D2 = db * b.D1D2 + cb1 * b.D2;
        result.D1D3 = db * b.D1D3 + cb1 * b.D3;
        result.D2D2 = db * b.D2D2 + cb2 * b.D2;
        result.D2D3 = db * b.D2D3 + cb2 * b.D3;
        result.D3D3 = db * b.D3D3 + cb3 * b.D3;
        return result;
    }

    public static DD4Scalar Divide(DD4Scalar a, double b)
    {
        var da = 1 / b;
    ...
    public static DD4Scalar Divide(DD4Scalar a, DD4Scalar b)
    {
        var da = 1 / b.Constant;
        var tmp = da * da;
        var db = -a.Constant * tmp;
        var dadb = -1 * tmp;
        var dbdb = -2 * db * da;
        var result = new DD4Scalar(a.Constant * da);
        result.D0 = da * a.D0 + db * b.D0;
        result.D1 = da * a.D1 + db * b.D1;
        result.D2 = da * a.D2 + db * b.D2;
        result.D3 = da * a.D3 + db * b.D3;
    ...
    public static DD5Scalar Divide(double a, DD5Scalar b)
    {
        var db = -a / (b.Constant * b.Constant);
        var dbdb = 2 * a / (b.Constant * b.Constant * b.Constant);
        ...
        result.D0D2 = db * b.D0D2 + cb0 * b.D2;
        result.D0D3 = db * b.D0D3 + cb0 * b.D3;
        result.D0D4 = db * b.D0D4 + cb0 * b.D4;
        result.D1D1 = db * b.D1D1 + cb1 * b.D1;
        result.D1D2 = db * b.D1D2 + cb1 * b.D2;
        result.D1D3 = db * b.D1D3 + cb1 * b.D3;
        result.D1D4 = db * b.D1D4 + cb1 * b.D4;
        result.D2D2 = db * b.D2D2 + cb2 * b.D2;
        result.D2D3 = db * b.D2D3 + cb2 * b.D3;
        result.D2D4 = db * b.D2D4 + cb2 * b.D4;
        result.D3D3 = db * b.D3D3 + cb3 * b.D3;
        result.D3D4 = db * b.D3D4 + cb3 * b.D4;
        result.D4D4 = db * b.D4D4 + cb4 * b.D4;
        return result;
    }

    public static DD5Scalar Divide(DD5Scalar a, double b)
    {
        var da = 1 / b;
    ...
    public static DD5Scalar Divide(DD5Scalar a, DD5Scalar b)
    {
        var da = 1 / b.Constant;
        var tmp = da * da;
        var db = -a.Constant * tmp;
        var dadb = -1 * tmp;
        var dbdb = -2 * db * da;
        var result = new DD5Scalar(a.Constant * da);
        result.D0 = da * a.D0 + db * b.D0;
        result.D1 = da * a.D1 + db * b.D1;
        result.D2 = da * a.D2 + db * b.D2;
        result.D3 = da * a.D3 + db * b.D3;
    ...
    public static DD6Scalar Divide(double a, DD6Scalar b)
    {
        var db = -a / (b.Constant * b.Constant);
        var dbdb = 2 * a / (b.Constant * b.Constant * b.Constant);
        ...
        result.D0D3 = db * b.D0D3 + cb0 * b.D3;
        result.D0D4 = db * b.D0D4 + cb0 * b.D4;
        result.D0D5 = db * b.D0D5 + cb0 * b.D5;
        result.D1D1 = db * b.D1D1 + cb1 * b.D1;
        result.D1D2 = db * b.D1D2 + cb1 * b.D2;
        result.D1D3 = db * b.D1D3 + cb1 * b.D3;
        result.D1D4 = db * b.D1D4 + cb1 * b.D4;
        result.D1D5 = db * b.D1D5 + cb1 * b.D5;
        result.D2D2 = db * b.D2D2 + cb2 * b.D2;
        result.D2D3 = db * b.D2D3 + cb2 * b.D3;
        result.D2D4 = db * b.D2D4 + cb2 * b.D4;
        result.D2D5 = db * b.D2D5 + cb2 * b.D5;
        result.D3D3 = db * b.D3D3 + cb3 * b.D3;
        result.D3D4 = db * b.D3D4 + cb3 * b.D4;
        result.D3D5 = db * b.D3D5 + cb3 * b.D5;
        result.D4D4 = db * b.D4D4 + cb4 * b.D4;
        result.D4D5 = db * b.D4D5 + cb4 * b.D5;
        result.D5D5 = db * b.D5D5 + cb5 * b.D5;
        return result;
    }

    public static DD6Scalar Divide(DD6Scalar a, double b)
    {
        var da = 1 / b;
    ...
    public static DD6Scalar Divide(DD6Scalar a, DD6Scalar b)
    {
        var da = 1 / b.Constant;
        var tmp = da * da;
        var db = -a.Constant * tmp;
        var dadb = -1 * tmp;
        var dbdb = -2 * db * da;
        var result = new DD6Scalar(a.Constant * da);
        result.D0 = da * a.D0 + db * b.D0;
        result.D1 = da * a.D1 + db * b.D1;
        result.D2 = da * a.D2 + db * b.D2;
        result.D3 = da * a.D3 + db * b.D3;
    ...
    public static DD7Scalar Divide(double a, DD7Scalar b)
    {
        var db = -a / (b.Constant * b.Constant);
        var dbdb = 2 * a / (b.Constant * b.Constant * b.Constant);
        ...
        result.D0D4 = db * b.D0D4 + cb0 * b.D4;
        result.D0D5 = db * b.D0D5 + cb0 * b.D5;
        result.D0D6 = db * b.D0D6 + cb0 * b.D6;
        result.D1D1 = db * b.D1D1 + cb1 * b.D1;
        result.D1D2 = db * b.D1D2 + cb1 * b.D2;
        result.D1D3 = db * b.D1D3 + cb1 * b.D3;
        result.D1D4 = db * b.D1D4 + cb1 * b.D4;
        result.D1D5 = db * b.D1D5 + cb1 * b.D5;
        result.D1D6 = db * b.D1D6 + cb1 * b.D6;
        result.D2D2 = db * b.D2D2 + cb2 * b.D2;
        result.D2D3 = db * b.D2D3 + cb2 * b.D3;
        result.D2D4 = db * b.D2D4 + cb2 * b.D4;
        result.D2D5 = db * b.D2D5 + cb2 * b.D5;
        result.D2D6 = db * b.D2D6 + cb2 * b.D6;
        result.D3D3 = db * b.D3D3 + cb3 * b.D3;
        result.D3D4 = db * b.D3D4 + cb3 * b.D4;
        result.D3D5 = db * b.D3D5 + cb3 * b.D5;
        result.D3D6 = db * b.D3D6 + cb3 * b.D6;
        result.D4D4 = db * b.D4D4 + cb4 * b.D4;
        result.D4D5 = db * b.D4D5 + cb4 * b.D5;
        result.D4D6 = db * b.D4D6 + cb4 * b.D6;
        result.D5D5 = db * b.D5D5 + cb5 * b.D5;
        result.D5D6 = db * b.D5D6 + cb5 * b.D6;
        result.D6D6 = db * b.D6D6 + cb6 * b.D6;
        return result;
    }

    public static DD7Scalar Divide(DD7Scalar a, double b)
    {
        var da = 1 / b;
    ...
    public static DD7Scalar Divide(DD7Scalar a, DD7Scalar b)
    {
        var da = 1 / b.Constant;
        var tmp = da * da;
        var db = -a.Constant * tmp;
        var dadb = -1 * tmp;
        var dbdb = -2 * db * da;
        var result = new DD7Scalar(a.Constant * da);
        result.D0 = da * a.D0 + db * b.D0;
        result.D1 = da * a.D1 + db * b.D1;
        result.D2 = da * a.D2 + db * b.D2;
        result.D3 = da * a.D3 + db * b.D3;
    ...
    public static DD8Scalar Divide(double a, DD8Scalar b)
    {
        var db = -a / (b.Constant * b.Constant);
        var dbdb = 2 * a / (b.Constant * b.Constant * b.Constant);
        ...
        result.D0D5 = db * b.D0D5 + cb0 * b.D5;
        result.D0D6 = db * b.D0D6 + cb0 * b.D6;
        result.D0D7 = db * b.D0D7 + cb0 * b.D7;
        result.D1D1 = db * b.D1D1 + cb1 * b.D1;
        result.D1D2 = db * b.D1D2 + cb1 * b.D2;
        result.D1D3 = db * b.D1D3 + cb1 * b.D3;
        result.D1D4 = db * b.D1D4 + cb1 * b.D4;
        result.D1D5 = db * b.D1D5 + cb1 * b.D5;
        result.D1D6 = db * b.D1D6 + cb1 * b.D6;
        result.D1D7 = db * b.D1D7 + cb1 * b.D7;
        result.D2D2 = db * b.D2D2 + cb2 * b.D2;
        result.D2D3 = db * b.D2D3 + cb2 * b.D3;
        result.D2D4 = db * b.D2D4 + cb2 * b.D4;
        result.D2D5 = db * b.D2D5 + cb2 * b.D5;
        result.D2D6 = db * b.D2D6 + cb2 * b.D6;
        result.D2D7 = db * b.D2D7 + cb2 * b.D7;
        result.D3D3 = db * b.D3D3 + cb3 * b.D3;
        result.D3D4 = db * b.D3D4 + cb3 * b.D4;
        result.D3D5 = db * b.D3D5 + cb3 * b.D5;
        result.D3D6 = db * b.D3D6 + cb3 * b.D6;
        result.D3D7 = db * b.D3D7 + cb3 * b.D7;
        result.D4D4 = db * b.D4D4 + cb4 * b.D4;
        result.D4D5 = db * b.D4D5 + cb4 * b.D5;
        result.D4D6 = db * b.D4D6 + cb4 * b.D6;
        result.D4D7 = db * b.D4D7 + cb4 * b.D7;
        result.D5D5 = db * b.D5D5 + cb5 * b.D5;
        result.D5D6 = db * b.D5D6 + cb5 * b.D6;
        result.D5D7 = db * b.D5D7 + cb5 * b.D7;
        result.D6D6 = db * b.D6D6 + cb6 * b.D6;
        result.D6D7 = db * b.D6D7 + cb6 * b.D7;
        result.D7D7 = db * b.D7D7 + cb7 * b.D7;
        return result;
    }

    public static DD8Scalar Divide(DD8Scalar a, double b)
    {
        var da = 1 / b;
    ...
    public static DD8Scalar Divide(DD8Scalar a, DD8Scalar b)
    {
        var da = 1 / b.Constant;
        var tmp = da * da;
        var db = -a.Constant * tmp;
        var dadb = -1 * tmp;
        var dbdb = -2 * db * da;
        var result = new DD8Scalar(a.Constant * da);
        result.D0 = da * a.D0 + db * b.D0;
        result.D1 = da * a.D1 + db * b.D1;
        result.D2 = da * a.D2 + db * b.D2;
        result.D3 = da * a.D3 + db * b.D3;
    ...
    public static DD9Scalar Divide(double a, DD9Scalar b)
    {
        var db = -a / (b.Constant * b.Constant);
        var dbdb = 2 * a / (b.Constant * b.Constant * b.Constant);
        ...
        result.D0D6 = db * b.D0D6 + cb0 * b.D6;
        result.D0D7 = db * b.D0D7 + cb0 * b.D7;
        result.D0D8 = db * b.D0D8 + cb0 * b.D8;
        result.D1D1 = db * b.D1D1 + cb1 * b.D1;
        result.D1D2 = db * b.D1D2 + cb1 * b.D2;
        result.D1D3 = db * b.D1D3 + cb1 * b.D3;
        result.D1D4 = db * b.D1D4 + cb1 * b.D4;
        ...
        result.D1D6 = db * b.D1D6 + cb1 * b.D6;
        result.D1D7 = db * b.D1D7 + cb1 * b.D7;
        result.D1D8 = db * b.D1D8 + cb1 * b.D8;
        result.D2D2 = db * b.D2D2 + cb2 * b.D2;
        result.D2D3 = db * b.D2D3 + cb2 * b.D3;
        result.D2D4 = db * b.D2D4 + cb2 * b.D4;
        result.D2D5 = db * b.D2D5 + cb2 * b.D5;
        result.D2D6 = db * b.D2D6 + cb2 * b.D6;
        result.D2D7 = db * b.D2D7 + cb2 * b.D7;
        result.D2D8 = db * b.D2D8 + cb2 * b.D8;
        result.D3D3 = db * b.D3D3 + cb3 * b.D3;
        result.D3D4 = db * b.D3D4 + cb3 * b.D4;
        result.D3D5 = db * b.D3D5 + cb3 * b.D5;
        result.D3D6 = db * b.D3D6 + cb3 * b.D6;
        result.D3D7 = db * b.D3D7 + cb3 * b.D7;
        result.D3D8 = db * b.D3D8 + cb3 * b.D8;
        result.D4D4 = db * b.D4D4 + cb4 * b.D4;
        result.D4D5 = db * b.D4D5 + cb4 * b.D5;
        result.D4D6 = db * b.D4D6 + cb4 * b.D6;
        result.D4D7 = db * b.D4D7 + cb4 * b.D7;
        result.D4D8 = db * b.D4D8 + cb4 * b.D8;
        result.D5D5 = db * b.D5D5 + cb5 * b.D5;
        result.D5D6 = db * b.D5D6 + cb5 * b.D6;
        result.D5D7 = db * b.D5D7 + cb5 * b.D7;
        result.D5D8 = db * b.D5D8 + cb5 * b.D8;
        result.D6D6 = db * b.D6D6 + cb6 * b.D6;
        result.D6D7 = db * b.D6D7 + cb6 * b.D7;
        result.D6D8 = db * b.D6D8 + cb6 * b.D8;
        result.D7D7 = db * b.D7D7 + cb7 * b.D7;
        result.D7D8 = db * b.D7D8 + cb7 * b.D8;
        result.D8D8 = db * b.D8D8 + cb8 * b.D8;
        return result;
    }

    public static DD9Scalar Divide(DD9Scalar a, double b)
    {
        var da = 1 / b;
    ...
    public static DD9Scalar Divide(DD9Scalar a, DD9Scalar b)
    {
        var da = 1 / b.Constant;
        var tmp = da * da;
        var db = -a.Constant * tmp;
        var dadb = -1 * tmp;
        var dbdb = -2 * db * da;
        var result = new DD9Scalar(a.Constant * da);
        result.D0 = da * a.D0 + db * b.D0;
        result.D1 = da * a.D1 + db * b.D1;
        result.D2 = da * a.D2 + db * b.D2;
        result.D3 = da * a.D3 + db * b.D3;
    ...
    public static DD10Scalar Divide(double a, DD10Scalar b)
    {
        var db = -a / (b.Constant * b.Constant);
        var dbdb = 2 * a / (b.Constant * b.Constant * b.Constant);
        ...
        result.D0D7 = db * b.D0D7 + cb0 * b.D7;
        result.D0D8 = db * b.D0D8 + cb0 * b.D8;
        result.D0D9 = db * b.D0D9 + cb0 * b.D9;
        result.D1D1 = db * b.D1D1 + cb1 * b.D1;
        result.D1D2 = db * b.D1D2 + cb1 * b.D2;
        result.D1D3 = db * b.D1D3 + cb1 * b.D3;
        result.D1D4 = db * b.D1D4 + cb1 * b.D4;
        ...
        result.D1D7 = db * b.D1D7 + cb1 * b.D7;
        result.D1D8 = db * b.D1D8 + cb1 * b.D8;
        result.D1D9 = db * b.D1D9 + cb1 * b.D9;
        result.D2D2 = db * b.D2D2 + cb2 * b.D2;
        result.D2D3 = db * b.D2D3 + cb2 * b.D3;
        result.D2D4 = db * b.D2D4 + cb2 * b.D4;
        result.D2D5 = db * b.D2D5 + cb2 * b.D5;
        ...
        result.D2D7 = db * b.D2D7 + cb2 * b.D7;
        result.D2D8 = db * b.D2D8 + cb2 * b.D8;
        result.D2D9 = db * b.D2D9 + cb2 * b.D9;
        result.D3D3 = db * b.D3D3 + cb3 * b.D3;
        result.D3D4 = db * b.D3D4 + cb3 * b.D4;
        result.D3D5 = db * b.D3D5 + cb3 * b.D5;
        result.D3D6 = db * b.D3D6 + cb3 * b.D6;
        result.D3D7 = db * b.D3D7 + cb3 * b.D7;
        result.D3D8 = db * b.D3D8 + cb3 * b.D8;
        result.D3D9 = db * b.D3D9 + cb3 * b.D9;
        result.D4D4 = db * b.D4D4 + cb4 * b.D4;
        result.D4D5 = db * b.D4D5 + cb4 * b.D5;
        result.D4D6 = db * b.D4D6 + cb4 * b.D6;
        result.D4D7 = db * b.D4D7 + cb4 * b.D7;
        result.D4D8 = db * b.D4D8 + cb4 * b.D8;
        result.D4D9 = db * b.D4D9 + cb4 * b.D9;
        result.D5D5 = db * b.D5D5 + cb5 * b.D5;
        result.D5D6 = db * b.D5D6 + cb5 * b.D6;
        result.D5D7 = db * b.D5D7 + cb5 * b.D7;
        result.D5D8 = db * b.D5D8 + cb5 * b.D8;
        result.D5D9 = db * b.D5D9 + cb5 * b.D9;
        result.D6D6 = db * b.D6D6 + cb6 * b.D6;
        result.D6D7 = db * b.D6D7 + cb6 * b.D7;
        result.D6D8 = db * b.D6D8 + cb6 * b.D8;
        result.D6D9 = db * b.D6D9 + cb6 * b.D9;
        result.D7D7 = db * b.D7D7 + cb7 * b.D7;
        result.D7D8 = db * b.D7D8 + cb7 * b.D8;
        result.D7D9 = db * b.D7D9 + cb7 * b.D9;
        result.D8D8 = db * b.D8D8 + cb8 * b.D8;
        result.D8D9 = db * b.D8D9 + cb8 * b.D9;
        result.D9D9 = db * b.D9D9 + cb9 * b.D9;
        return result;
    }

    public static DD10Scalar Divide(DD10Scalar a, double b)
    {
        var da = 1 / b;
    ...
    public static DD10Scalar Divide(DD10Scalar a, DD10Scalar b)
    {
        var da = 1 / b.Constant;
        var tmp = da * da;
        var db = -a.Constant * tmp;
        var dadb = -1 * tmp;
        var dbdb = -2 * db * da;
        var result = new DD10Scalar(a.Constant * da);
        result.D0 = da * a.D0 + db * b.D0;
        result.D1 = da * a.D1 + db * b.D1;
        result.D2 = da * a.D2 + db * b.D2;
        result.D3 = da * a.D3 + db * b.D3;
    ...
    public static DD11Scalar Divide(double a, DD11Scalar b)
    {
        var db = -a / (b.Constant * b.Constant);
        var dbdb = 2 * a / (b.Constant * b.Constant * b.Constant);
        ...
        result.D0D8 = db * b.D0D8 + cb0 * b.D8;
        result.D0D9 = db * b.D0D9 + cb0 * b.D9;
        result.D0D10 = db * b.D0D10 + cb0 * b.D10;
        result.D1D1 = db * b.D1D1 + cb1 * b.D1;
        result.D1D2 = db * b.D1D2 + cb1 * b.D2;
        result.D1D3 = db * b.D1D3 + cb1 * b.D3;
        result.D1D4 = db * b.D1D4 + cb1 * b.D4;
        ...
        result.D1D8 = db * b.D1D8 + cb1 * b.D8;
        result.D1D9 = db * b.D1D9 + cb1 * b.D9;
        result.D1D10 = db * b.D1D10 + cb1 * b.D10;
        result.D2D2 = db * b.D2D2 + cb2 * b.D2;
        result.D2D3 = db * b.D2D3 + cb2 * b.D3;
        result.D2D4 = db * b.D2D4 + cb2 * b.D4;
        result.D2D5 = db * b.D2D5 + cb2 * b.D5;
        ...
        result.D2D8 = db * b.D2D8 + cb2 * b.D8;
        result.D2D9 = db * b.D2D9 + cb2 * b.D9;
        result.D2D10 = db * b.D2D10 + cb2 * b.D10;
        result.D3D3 = db * b.D3D3 + cb3 * b.D3;
        result.D3D4 = db * b.D3D4 + cb3 * b.D4;
        result.D3D5 = db * b.D3D5 + cb3 * b.D5;
        result.D3D6 = db * b.D3D6 + cb3 * b.D6;
        ...
        result.D3D8 = db * b.D3D8 + cb3 * b.D8;
        result.D3D9 = db * b.D3D9 + cb3 * b.D9;
        result.D3D10 = db * b.D3D10 + cb3 * b.D10;
        result.D4D4 = db * b.D4D4 + cb4 * b.D4;
        result.D4D5 = db * b.D4D5 + cb4 * b.D5;
        result.D4D6 = db * b.D4D6 + cb4 * b.D6;
        result.D4D7 = db * b.D4D7 + cb4 * b.D7;
        result.D4D8 = db * b.D4D8 + cb4 * b.D8;
        result.D4D9 = db * b.D4D9 + cb4 * b.D9;
        result.D4D10 = db * b.D4D10 + cb4 * b.D10;
        result.D5D5 = db * b.D5D5 + cb5 * b.D5;
        result.D5D6 = db * b.D5D6 + cb5 * b.D6;
        result.D5D7 = db * b.D5D7 + cb5 * b.D7;
        result.D5D8 = db * b.D5D8 + cb5 * b.D8;
        result.D5D9 = db * b.D5D9 + cb5 * b.D9;
        result.D5D10 = db * b.D5D10 + cb5 * b.D10;
        result.D6D6 = db * b.D6D6 + cb6 * b.D6;
        result.D6D7 = db * b.D6D7 + cb6 * b.D7;
        result.D6D8 = db * b.D6D8 + cb6 * b.D8;
        result.D6D9 = db * b.D6D9 + cb6 * b.D9;
        result.D6D10 = db * b.D6D10 + cb6 * b.D10;
        result.D7D7 = db * b.D7D7 + cb7 * b.D7;
        result.D7D8 = db * b.D7D8 + cb7 * b.D8;
        result.D7D9 = db * b.D7D9 + cb7 * b.D9;
        result.D7D10 = db * b.D7D10 + cb7 * b.D10;
        result.D8D8 = db * b.D8D8 + cb8 * b.D8;
        result.D8D9 = db * b.D8D9 + cb8 * b.D9;
        result.D8D10 = db * b.D8D10 + cb8 * b.D10;
        result.D9D9 = db * b.D9D9 + cb9 * b.D9;
        result.D9D10 = db * b.D9D10 + cb9 * b.D10;
        result.D10D10 = db * b.D10D10 + cb10 * b.D10;
        return result;
    }

    public static DD11Scalar Divide(DD11Scalar a, double b)
    {
        var da = 1 / b;
    ...
    public static DD11Scalar Divide(DD11Scalar a, DD11Scalar b)
    {
        var da = 1 / b.Constant;
        var tmp = da * da;
        var db = -a.Constant * tmp;
        var dadb = -1 * tmp;
        var dbdb = -2 * db * da;
        var result = new DD11Scalar(a.Constant * da);
        result.D0 = da * a.D0 + db * b.D0;
        result.D1 = da * a.D1 + db * b.D1;
        result.D2 = da * a.D2 + db * b.D2;
        result.D3 = da * a.D3 + db * b.D3;
    ...
    public static DD12Scalar Divide(double a, DD12Scalar b)
    {
        var db = -a / (b.Constant * b.Constant);
        var dbdb = 2 * a / (b.Constant * b.Constant * b.Constant);
        ...
        result.D0D9 = db * b.D0D9 + cb0 * b.D9;
        result.D0D10 = db * b.D0D10 + cb0 * b.D10;
        result.D0D11 = db * b.D0D11 + cb0 * b.D11;
        result.D1D1 = db * b.D1D1 + cb1 * b.D1;
        result.D1D2 = db * b.D1D2 + cb1 * b.D2;
        result.D1D3 = db * b.D1D3 + cb1 * b.D3;
        result.D1D4 = db * b.D1D4 + cb1 * b.D4;
        ...
        result.D1D9 = db * b.D1D9 + cb1 * b.D9;
        result.D1D10 = db * b.D1D10 + cb1 * b.D10;
        result.D1D11 = db * b.D1D11 + cb1 * b.D11;
        result.D2D2 = db * b.D2D2 + cb2 * b.D2;
        result.D2D3 = db * b.D2D3 + cb2 * b.D3;
        result.D2D4 = db * b.D2D4 + cb2 * b.D4;
        result.D2D5 = db * b.D2D5 + cb2 * b.D5;
        ...
        result.D2D9 = db * b.D2D9 + cb2 * b.D9;
        result.D2D10 = db * b.D2D10 + cb2 * b.D10;
        result.D2D11 = db * b.D2D11 + cb2 * b.D11;
        result.D3D3 = db * b.D3D3 + cb3 * b.D3;
        result.D3D4 = db * b.D3D4 + cb3 * b.D4;
        result.D3D5 = db * b.D3D5 + cb3 * b.D5;
        result.D3D6 = db * b.D3D6 + cb3 * b.D6;
        ...
        result.D3D9 = db * b.D3D9 + cb3 * b.D9;
        result.D3D10 = db * b.D3D10 + cb3 * b.D10;
        result.D3D11 = db * b.D3D11 + cb3 * b.D11;
        result.D4D4 = db * b.D4D4 + cb4 * b.D4;
        result.D4D5 = db * b.D4D5 + cb4 * b.D5;
        result.D4D6 = db * b.D4D6 + cb4 * b.D6;
        result.D4D7 = db * b.D4D7 + cb4 * b.D7;
        ...
        result.D4D9 = db * b.D4D9 + cb4 * b.D9;
        result.D4D10 = db * b.D4D10 + cb4 * b.D10;
        result.D4D11 = db * b.D4D11 + cb4 * b.D11;
        result.D5D5 = db * b.D5D5 + cb5 * b.D5;
        result.D5D6 = db * b.D5D6 + cb5 * b.D6;
        result.D5D7 = db * b.D5D7 + cb5 * b.D7;
        result.D5D8 = db * b.D5D8 + cb5 * b.D8;
        result.D5D9 = db * b.D5D9 + cb5 * b.D9;
        result.D5D10 = db * b.D5D10 + cb5 * b.D10;
        result.D5D11 = db * b.D5D11 + cb5 * b.D11;
        result.D6D6 = db * b.D6D6 + cb6 * b.D6;
        result.D6D7 = db * b.D6D7 + cb6 * b.D7;
        result.D6D8 = db * b.D6D8 + cb6 * b.D8;
        result.D6D9 = db * b.D6D9 + cb6 * b.D9;
        result.D6D10 = db * b.D6D10 + cb6 * b.D10;
        result.D6D11 = db * b.D6D11 + cb6 * b.D11;
        result.D7D7 = db * b.D7D7 + cb7 * b.D7;
        result.D7D8 = db * b.D7D8 + cb7 * b.D8;
        result.D7D9 = db * b.D7D9 + cb7 * b.D9;
        result.D7D10 = db * b.D7D10 + cb7 * b.D10;
        result.D7D11 = db * b.D7D11 + cb7 * b.D11;
        result.D8D8 = db * b.D8D8 + cb8 * b.D8;
        result.D8D9 = db * b.D8D9 + cb8 * b.D9;
        result.D8D10 = db * b.D8D10 + cb8 * b.D10;
        result.D8D11 = db * b.D8D11 + cb8 * b.D11;
        result.D9D9 = db * b.D9D9 + cb9 * b.D9;
        result.D9D10 = db * b.D9D10 + cb9 * b.D10;
        result.D9D11 = db * b.D9D11 + cb9 * b.D11;
        result.D10D10 = db * b.D10D10 + cb10 * b.D10;
        result.D10D11 = db * b.D10D11 + cb10 * b.D11;
        result.D11D11 = db * b.D11D11 + cb11 * b.D11;
        return result;
    }

    public static DD12Scalar Divide(DD12Scalar a, double b)
    {
        var da = 1 / b;
    ...
    public static DD12Scalar Divide(DD12Scalar a, DD12Scalar b)
    {
        var da = 1 / b.Constant;
        var tmp = da * da;
        var db = -a.Constant * tmp;
        var dadb = -1 * tmp;
        var dbdb = -2 * db * da;
        var result = new DD12Scalar(a.Constant * da);
        result.D0 = da * a.D0 + db * b.D0;
        result.D1 = da * a.D1 + db * b.D1;
        result.D2 = da * a.D2 + db * b.D2;
        result.D3 = da * a.D3 + db * b.D3;
